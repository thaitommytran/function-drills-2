...
// CODE HERE
const ordersAfterTax = orders.map((orderObj) => {
  return orderObj.price * (1 + orderObj.tax);
});
...
// CODE HERE
const sumBobsTotal = purchases
  .filter((ownerObj) => ownerObj.owner === "Bob")
  .map((ownerObj) => ownerObj.price)
